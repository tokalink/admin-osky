<?php namespace App\Http\Controllers;
	...
	class AdminProjectsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Lead Name","name"=>"lead_id","join"=>"leads,name"];
			$this->col[] = ["label"=>"Date","name"=>"date"];
			$this->col[] = ["label"=>"Tgl Jatuh Tempo","name"=>"tgl_jatuh_tempo"];
			$this->col[] = ["label"=>"Status Payment","name"=>"status_payment"];
			$this->col[] = ["label"=>"Tgl Payment","name"=>"tgl_payment"];
			...
			$this->form[] = ['label'=>'Tgl Payment','name'=>'tgl_payment','type'=>'date','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'File1','name'=>'file1','type'=>'upload','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'File2','name'=>'file2','type'=>'upload','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'File3','name'=>'file3','type'=>'upload','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Follow Up  1','name'=>'progress_fu1','type'=>'textarea','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Lead Id","name"=>"lead_id","type"=>"select2","required"=>TRUE,"validation"=>"required|min:1|max:255","datatable"=>"lead,id"];
			//$this->form[] = ["label"=>"Date","name"=>"date","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			//$this->form[] = ["label"=>"Tgl Jatuh Tempo","name"=>"tgl_jatuh_tempo","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			//$this->form[] = ["label"=>"Status Payment","name"=>"status_payment","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Tgl Payment","name"=>"tgl_payment","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			//$this->form[] = ["label"=>"File1","name"=>"file1","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"File2","name"=>"file2","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"File3","name"=>"file3","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
